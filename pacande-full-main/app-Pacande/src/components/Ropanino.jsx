...
const ropaNiñoProducts = [
  {
    title: "Camiseta Azul Niño",
    price: 50000,
    image: "https://via.placeholder.com/150x150?text=Camiseta+Azul+Niño",
    sizes: ["2T", "3T", "4T", "5", "6"],
    discount: false,
    category: "Camisetas",
  },
  {
    title: "Pantalón Niño",
    price: 120000,
    image: "https://via.placeholder.com/150x150?text=Pantalón+Niño",
    sizes: ["2T", "3T", "4T", "5", "6"],
    discount: false,
    category: "Pantalones",
  },
  {
    title: "Chaqueta Niño",
    price: 180000,
    image: "https://via.placeholder.com/150x150?text=Chaqueta+Niño",
    sizes: ["2T", "3T", "4T", "5", "6"],
    discount: true,
    category: "Chaquetas",
  },
  {
    ...
    price: 50000,
    image: "https://via.placeholder.com/150x150?text=Camiseta+Roja+Niño",
    sizes: ["2T", "3T", "4T", "5", "6"],
    discount: true,
    category: "Camisetas",
  },
  {
    title: "Pantalón Verde Niño",
    price: 120000,
    image: "https://via.placeholder.com/150x150?text=Pantalón+Verde+Niño",
    sizes: ["2T", "3T", "4T", "5", "6"],
    discount: false,
    category: "Pantalones",
  },
  {
    title: "Chaqueta Gris Niño",
    price: 180000,
    image: "https://via.placeholder.com/150x150?text=Chaqueta+Gris+Niño",
    sizes: ["2T", "3T", "4T", "5", "6"],
    discount: true,
    category: "Chaquetas",
  },
...
const RopaNiñoPage = () => {
  ...
  const renderSection = (category) => {
    const filteredProducts = filteredRopaNiño.filter(
