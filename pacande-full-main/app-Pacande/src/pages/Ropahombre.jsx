...
const RopaHombrePage = () => {
  const [currency, setCurrency] = useState("COP");
  const [exchangeRates, setExchangeRates] = useState({});
  const [products, setProducts] = useState([]);
  const selectedCategory = "Ropa";
  const selectedSubcategory = "Hombre";
  ...
  return (
    <Container>
      <MainContent>
        <CategoryHeader backgroundImage={hombre}>
          <h1>Ropa Hombre</h1>
          <p>Encuentra tu estilo con nuestra colección masculina. Diseños modernos y cómodos para cada ocasión.</p>
        </CategoryHeader>
