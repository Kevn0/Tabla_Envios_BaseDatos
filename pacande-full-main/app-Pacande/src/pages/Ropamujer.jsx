...
const RopaMujerPage = () => {
  ...
  const selectedSubcategory = "Mujer";
  ...
  return (
    <Container>
      <MainContent>
        <CategoryHeader backgroundImage={mujer}>
          <h1>Ropa Mujer</h1>
          <p>Descubre las últimas tendencias en moda femenina. Encuentra tu estilo único con nuestra colección exclusiva.</p>
        </CategoryHeader>
