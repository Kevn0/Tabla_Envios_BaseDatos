...
const BannerSection = styled.div`
  ...
  background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),
    url(${celulares}) center/cover no-repeat;
  display: flex;
...
const TecnologiaMainPage = () => {
  const categories = [
    {
      title: "Celulares",
      image: celulares,
      path: "/Teccel",
      description: "Descubre los últimos smartphones y dispositivos móviles"
    },
    {
      title: "Computadores",
      image: computadores,
      path: "/Tecpc",
      description: "Encuentra el equipo perfecto para trabajo o gaming"
    },
    {
      title: "Accesorios",
      image: accesorios,
  ...
  return (
    <Container>
      <BannerSection>
        <BannerTitle>TECNOLOGÍA</BannerTitle>
        <BannerDescription>
          Descubre lo último en tecnología. Equipos de alta calidad para mantenerte
...
export default TecnologiaMainPage; 