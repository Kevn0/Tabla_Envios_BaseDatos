...
const BaloncestoPage = () => {
  ...
  return (
    <Container>
      <MainContent>
        <CategoryHeader backgroundImage={baloncesto}>
          <h1>Baloncesto</h1>
          <p>Descubre nuestra selección de equipamiento profesional para baloncesto. Desde zapatillas hasta accesorios de entrenamiento.</p>
        </CategoryHeader>
        <BorderedContainer>
          <ProductGallery
