...
const ComputadoresPage = () => {
  ...
  const selectedSubcategory = "Computadores";
  ...
  return (
    <Container>
      <MainContent>
        <CategoryHeader backgroundImage={computadores}>
          <h1>Computadores</h1>
          <p>Encuentra el equipo perfecto para trabajo o gaming. Las últimas tecnologías en computadores y laptops.</p>
        </CategoryHeader>
