// src/pages/AccesoriosTecnologicosPage.js
...
const AccesoriosPage = () => {
  ...
  const selectedSubcategory = "Accesorios";
  ...
  return (
    <Container>
      <MainContent>
        <CategoryHeader backgroundImage={accesorios}>
          <h1>Accesorios</h1>
          <p>Complementa tus dispositivos con los mejores accesorios. Encuentra todo lo que necesitas para mejorar tu experiencia tecnológica.</p>
        </CategoryHeader>
